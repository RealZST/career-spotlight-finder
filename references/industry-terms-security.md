...
> **Usage note:** This is a supplementary reference for terms practitioners commonly *do* but rarely *name*. Claude already knows mainstream security terminology. Use this file to catch colloquial or informal descriptions and map them to the recognized industry terms that belong on a resume or portfolio.
